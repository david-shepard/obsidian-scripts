...
Some standalone ([snippets/](./snippets)) as well as [templater](https://silentvoid13.github.io/Templater) templates/scripts
...
- [QuickAdd](https://quickadd.obsidian.guide/) (optional)
- [Codescript Toolkit](https://github.com/mnaoumov/obsidian-codescript-toolkit) (optional)

## Other plugins I use
- [Front Matter Title](https://obsidian.md/plugins?id=obsidian-front-matter-title-plugin)
- [Global Search and Replace](https://obsidian.md/plugins?id=global-search-and-replace)
- [Settings Search](https://obsidian.md/plugins?id=settings-search)
- [Editing Toolbar](https://obsidian.md/plugins?id=editing-toolbar)
- [Recent Files](https://obsidian.md/plugins?id=recent-files-obsidian)
- [Sync Safe Filenames](https://obsidian.md/plugins?id=sync-safe-file-names)
- [Tag Wrangler](https://obsidian.md/plugins?id=tag-wrangler)
- [Text Extractor](https://obsidian.md/plugins?id=text-extractor)
...
- [Media DB](https://obsidian.md/plugins?id=obsidian-media-db-plugin)
- [TaskNotes](https://obsidian.md/plugins?id=tasknotes)
